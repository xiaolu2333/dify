          ...
          <>
            <MenuButton className={cn(
              ...
              <div className='flex flex-row'>
                <div
                  className={'system-sm-medium max-w-[160px] truncate text-text-secondary'}>{currentWorkspace?.name}</div>
              ...
              >
                <div
                  ...
                  <div className='flex items-start self-stretch px-3 pb-0.5 pt-1'>
                    <span
                      className='system-xs-medium-uppercase flex-1 text-text-tertiary'>{t('common.userProfile.workspace')}</span>
                  </div>
                  {
                    workspaces.map(workspace => (
                      <div
                        className='flex items-center gap-2 self-stretch rounded-l py-1 pl-5 pr-5 hover:bg-state-base-hover'
                        ...
                        {/*</div>*/}
                        <div
                          className='system-md-regular line-clamp-1 grow cursor-pointer overflow-hidden text-ellipsis text-text-secondary'>{workspace.name}</div>

    ...
    return [
      {
        ...
        destination: 'http://172.28.79.13:10000/console/api/:path*'
      },
      {
        source: '/api/:path*',
        destination: 'http://172.28.79.13:10000/api/:path*'
      },
      {
        source: '/files',
        destination: 'http://172.28.79.13:10000/files/:path*'
      },
      {
        source: '/datasets',
        destination: 'http://172.28.79.13:10000/datasets:path*'
      },
      {
        source: '/explore/apps',
        destination: 'http://172.28.79.13:10000/explore/apps:path*'
      },
      {
        source: '/',
        destination: 'http://172.28.79.13:10000/:path*'
      }
    ]
  }
}
